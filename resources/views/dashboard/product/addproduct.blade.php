...
<html lang="en">
    <head>
        ...
        <title>Organotani | Add Product</title>
                            ...
                            <div class="card-body">
                                <form action="{{route('storeproduct')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                      ...
                                      <input type="text" class="form-control @error('namaproduct') is-invalid @enderror" id="namaproduct" name="namaproduct" aria-describedby="errornamaproduct">
                                      @error('namaproduct')
                                    ...
                                    <div class="mb-3">
                                      ...
                                      <input class="form-control @error('gambarproduct') is-invalid @enderror" type="file" name="gambarproduct" id="gambarproduct" accept="image/*"  aria-describedby="errorgambarproduct">
                                      @error('gambarproduct')
                                    ...
                                    <div class="mb-3">
                                      ...
                                      <input type="text" class="form-control @error('hargaproduct') is-invalid @enderror" id="hargaproduct"  name="hargaproduct" aria-describedby="errorhargaproduct">
                                      @error('hargaproduct')
                                    ...
                                    <div class="mb-3">
                                      ...
                                      <textarea name="deskripsiproduct" id="deskripsiproduct" class="form-control @error('deskripsiproduct') is-invalid @enderror" cols="10" rows="10" aria-describedby="errordeskripsiproduct"></textarea>
                                    ...
                                    <div class="mb-3">
                                      ...
                                      <input type="number" class="form-control @error('stockproduct') is-invalid @enderror" id="stockproduct"  name="stockproduct" aria-describedby="errorstockproduct">
                                      @error('stockproduct')
