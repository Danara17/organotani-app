                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    <button class="btn btn-outline-danger rounded-0 dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                      Aksi
                                                    </button>
                                                    <ul class="dropdown-menu rounded-0">
                                                      <li><a class="dropdown-item" href="dashboard/user/detail/{{$item->id}}">detail</a></li>
                                                      <li><a class="dropdown-item" href="/dashboard/user/edit/{{$item->id}}">edit</a></li>
                                                    </ul>
                                                  </div>                                     
                                            </td>
                                        </tr> 
