    ...
    <div class="container mt-5">
      <div class="row">
          <div class="col-md-4 d-flex justify-content-center">
              <!-- Gambar Produk -->
              <img src="{{asset('product/' . $product->gambarproduct)}}" alt="{{$product->deskripsiproduct}}" class="img-fluid img-thumbnail border border-3 shadow">
          </div>
          <div class="col-md-8">
              ...
              <div class="mb-3 row">
                <label for="namaProduk" class="col-sm-2 col-form-label"><strong>Nama Produk</strong></label>
                <div class="col-sm-10">
                    <input type="text" readonly class="form-control-plaintext" id="namaProduk" value="{{$product->namaproduct}}">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control-plaintext" id="hargaProduk" readonly value="Rp. {{number_format($product->hargaproduct,0,',','.')}}">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control-plaintext" id="stockProduk" readonly value="{{$product->stockproduct}}">
                </div>
            </div>
              ...
              <form action="{{route('ordernow')}}" method="post">
                ...
                @csrf
                  ...
                  <div class="form-group">
                      <input type="number" required class="form-control" id="quantity" name="quantity" placeholder="Masukkan jumlah produk yang ingin dibeli">
                  </div>
                  ...
                  <div class="d-flex justify-content-end mt-3">
                    <button type="button" class="button-buy" data-bs-toggle="modal" data-bs-target="#exampleModal">
                      Beli
                    </button>
                  </div>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-body">
                          <h5>Apakah anda yakin membeli product ini ?</h5>
                        </div>
                        <div class="modal-footer">
                          <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Tidak</button>
                          <button type="submit" class="btn btn-outline-primary">Ya, beli sekarang</button>
                        </div>
                      </div>
                    </div>
                  </div>
