...
<html lang="en">
  <head>
    ...
    <title>Organotani | Pesanan Saya</title>
  ...
  <body>
    ...
    <div class="container mt-5">
      ...
      <h1>Pesanan Saya</h1> 
      <cite >Welcome, Pesanan anda disini {{auth()->user()->username}}. </cite>

        @foreach ($orders as $item)
        <div class="mt-3 w-100">
            <div class="card shadow rounded-0">
                <div class="card-body">
                    <h5>{{ $item->product->namaproduct }} | {{$item->created_at}}</h5>
                    <hr class="hr">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-3"><strong>Product</strong></div>
                            <div class="col-md-9">: {{ $item->product->namaproduct }}</div>
                        </div>
                        <div class="row">
                            <div class="col-md-3"><strong>Quantity</strong></div>
                            <div class="col-md-9">: {{ $item->total_bayar/$item->product->hargaproduct }}</div>
                        </div>
                        <div class="row">
                            <div class="col-md-3"><strong>Price</strong></div>
                            <div class="col-md-9">: <strong><em>Rp. {{ number_format($item->total_bayar , 2) }}</em></strong></div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-end">
                        <a href="{{'/invoice' . '/' . $item->id}}" class="button-buy">Show</a>
                    </div>
                </div>
            </div>
        </div>
